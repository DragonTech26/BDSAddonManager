...
namespace AddonManager.Forms
{
    public partial class ResourcePackForm : Form
    {
        ...
        private void rpInactiveListView_DragEnter(object sender, DragEventArgs e) //Handles detection for importing packs
        {
            packHandler.DragEnterHandler(e);
        }
        private void rpInactiveListView_DragDrop(object sender, DragEventArgs e) //Handles importing of packs
        {
